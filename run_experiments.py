...
if __name__ == "__main__":
    ...
    parser.add_argument('--env', help="Training environment", default="widowx_reacher-v1", type=str)
    parser.add_argument('--n-timesteps', help="Number of timesteps", default=3000, type=int)
    parser.add_argument('--n-seeds', help="Number of seeds", default=5, type=int)
    ...
    if os.path.isdir(LOG_FOLDER):
        ...
        while answer not in ("Y", "n"): 
            answer = input("This experiment ID already exist. Do you still want to launch the experiment ? [Y/n] ") 
            if answer == "Y":
                break
            elif answer == "n":
    ...
    for seed in range(args.n_seeds):
        ...
        print("Exp #{}: Training env {} with algo {} and seed {}...".format(args.exp_id, args.env, args.algo, seed))
